...
* Classified vendors based on:
    * Data sensitivity
    * Level of system access
    * Business criticality
Purpose: Prioritize security efforts based on risk impact.

2️⃣ Vendor Onboarding & Due Diligence
Reviewed whether vendors were:
* Assessed using security questionnaires
* Required to meet minimum security standards
* Contractually obligated to follow cybersecurity requirements
Finding: Vendor onboarding lacked consistency and formal security validation.

3️⃣ Access Control & Data Handling
Evaluated:
* Least privilege enforcement
* Vendor access review processes
* Data encryption and protection requirements
Risk Identified: Excessive vendor access and limited visibility into data handling practices.
...
Gap: No formal vendor incident response or breach escalation procedures.

5️⃣ Risk Scoring & Reporting
Developed:
* Vendor risk tiers (Low / Medium / High)
...
* Establish breach notification SLAs
* Perform annual vendor security reviews
Long-Term (6–12 Months)
* Implement continuous vendor risk monitoring
* Integrate vendor risk into the enterprise risk register
* Provide executive-level vendor risk reporting
